...
<head>
    ...
    <title>Tableau de bord - Cours</title>
 ...
 <style>
      ...
      /* Ajoutez ces styles CSS pour les bordures */
.searchbox {
    display: flex;
    align-items: center;
    border: 1px solid #ccc; /* Couleur de la bordure et épaisseur */
    border-radius: 5px; /* Rayon des coins pour arrondir les bordures */
    padding: 5px; /* Espace intérieur du champ de recherche */
}

.search-text {
    border: none; /* Supprimez la bordure par défaut du champ de texte */
    outline: none; /* Supprimez la bordure d'ombre lorsque le champ est en surbrillance */
    width: 200px; /* Ajustez la largeur du champ de texte selon vos besoins */
    padding: 5px; /* Espace intérieur du champ de texte */
}
...
<div class="container">
    ...
    <a href="logout.php">
        <img src="https://source.unsplash.com/36x36/?human" alt="User Image" />
    </a>
</div>
